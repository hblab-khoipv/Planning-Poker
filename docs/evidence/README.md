...
| File                              | What it shows                                                                                                                                                               |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `voting-01-deck-host.png`         | Round 1 open (PRD §4 step 5): the room's own `fibonacci` deck, nobody has voted, and the host sees “Lật bài”.                                                                |
...
| `voting-04-revealed-host.png`     | **FR-5/FR-6.** The host pressed “Lật bài”: every card up (2, 5, 8), trung bình 5, median 5, 3 lượt vote, and no consensus badge.                                             |
